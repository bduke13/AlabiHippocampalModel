...
from multiscale_grid_driver_v2 import MultiscaleDriverWithGrid
...
SCALES_DEFS = {
    ...
    "medium": {
        ...
        "frequency_divisor": 0.5,  # Medium grid scale
    },
    "large": {
        "scale_index": 2,
        "name": "large",
        ...
        "frequency_divisor": 1.0,  # Larger grid scale (lower frequency)
    },
    "xlarge": {
        "scale_index": 3,
        "name": "xlarge",
    ...
    for corner in corners:
        ...
        for _ in range(num_loops):
            ...
            bot.initialization(
                ...
                max_dist=kwargs.get("max_dist", max_dist),
