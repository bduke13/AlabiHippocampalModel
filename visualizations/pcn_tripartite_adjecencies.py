...
if __name__ == "__main__":
    from visualizations.vis_utils import load_layer_pkl

    # Load history maps directly
    ...
    # Load Place Cell Network directly from local pkl
    with open(NET_DIR / "pcn.pkl", "rb") as f:
        pcn = pickle.load(f)
