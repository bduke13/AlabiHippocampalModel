...
class Driver(Create3Supervisor):
    ...
    def sense(self):
        ...
        boundaries = np.roll(self.boundaries, 2 * self.current_heading_deg)
        ...
        self.v_in = np.array([np.cos(current_heading_rad), np.sin(current_heading_rad)])
    ...
    def compute(self):
        ...
        # Compute the activations of the head direction cells based on the current heading vector (v_in).
