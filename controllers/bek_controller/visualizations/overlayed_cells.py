...
# Load hmap data
with open(r"controllers\bek_controller\hmap_x.pkl", "rb") as f:
    hmap_x = np.array(pickle.load(f))
with open(r"controllers\bek_controller\hmap_y.pkl", "rb") as f:
    hmap_y = np.array(pickle.load(f))
with open(r"controllers\bek_controller\hmap_z_large.pkl", "rb") as f:
